...
/**
 * DAO class for all the class Attendance related operations
 * 
 * @author Naren
 * 
 */
public class ClassAttendanceOperationsDAO extends BaseOperationsDAO {
	...
	public ClassAttendanceDef createDefaultClassAttendanceDef(Integer classId) throws Exception {
		...
		Class classObj = retrieveClassForId(classId);
