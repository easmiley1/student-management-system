...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='table to contain all the months for attendance register for a particular class';
...
-- Dump completed on 2013-02-14  0:29:23
